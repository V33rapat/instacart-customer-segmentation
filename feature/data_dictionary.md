...
| monetary_total        | float | Total monetary value spent by the customer        | ยอดเงินรวมทั้งหมดที่ลูกค้าใช้จ่าย               |
| monetary_avg          | float | Average spending per order                        | ค่าเฉลี่ยยอดใช้จ่ายต่อคำสั่งซื้อ                |
| monetary_std          | float | Standard deviation of spending per order          | ส่วนเบี่ยงเบนมาตรฐานของยอดใช้จ่ายต่อคำสั่งซื้อ  |
...
| days_since_prior_min  | int   | Minimum days between orders                       | จำนวนวันต่ำสุดระหว่างคำสั่งซื้อ                 |
| days_since_prior_max  | int   | Maximum days between orders                       | จำนวนวันสูงสุดระหว่างคำสั่งซื้อ                 |
